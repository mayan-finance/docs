...
**User experience:**<br />Swift abstracts all technical steps—and there is no need for users or integrators to manually interact with contracts or manage asset locking. Mayan automatically orchestrates the flow to ensure a smooth experience.

**Protocol fee:**<br />Swift charges a fee of 3 basis points (0.03%).
