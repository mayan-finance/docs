...
That ordering is what makes it fast. Most Swift orders settle in around 6 seconds, because the user is paid before the cross-chain message is verified rather than after the source chain finalizes.
...
- Settlement in around 6 seconds, because the driver fronts the delivery rather than waiting on the source chain.
