...
Wormhole Swap typically settles in around two minutes, bounded by Guardian attestation on the source chain.
...
**Protocol fee:**<br />The Wormhole Swap fees are set at 10 basis points (0.10%).
