...
sidebarTitle: "MCTP / Fast MCTP"
---

**What it is:**<br />The MCTP (Mayan-Circle Transfer Protocol) method converts input tokens to USDC and sends them to the destination chain via Circle’s CCTP. Drivers then compete on Solana to deliver the best rate for swapping USDC into the user’s requested output token.
...
![Mayan-CCTP-Swap.png](/images/Mayan-CCTP-Swap.png)
...
**Fast MCTP:**<br />A variant using Circle CCTPv2. The flow and structure are identical to MCTP, but settlement is quicker: Fast MCTP typically completes in around 20 seconds, against around two minutes for standard MCTP. Protocol fee is 3 basis points.
