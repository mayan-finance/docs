...
**Fast MCTP:**<br />A variant using Circle CCTPv2. The flow and structure are identical to MCTP, but settlement is quicker. Transfers over MCTP settle in as little as 5 seconds. Protocol fee is 3 basis points.
