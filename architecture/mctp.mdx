...
**Fast MCTP:**<br />A variant using Circle CCTPv2 for faster settlement and more efficient messaging. Flow and structure are identical; finality is faster and latency reduced. Protocol fee is 3 basis points.
