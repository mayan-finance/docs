---
title: "HyperCore Deposits & Withdrawals"
description: "Deposit USDC into a HyperCore (Hyperliquid) spot or perps balance from any supported chain, and withdraw USDC back out to an EVM chain, using the Mayan Swap SDK."
---

## Overview

Mayan supports **direct HyperCore (Hyperliquid Core) deposits and withdrawals** through the
