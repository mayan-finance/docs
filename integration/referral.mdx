...
- For **Swift V2 (EVM source)** orders:
  - Referral fees are **deposited into the [fee manager contract](https://etherscan.io/address/0x26227ACE40de5671e8355fCAFf65a0522aa7b303)**.
  - Referrers can **withdraw** them using your referrer wallet via the [Swift fee withdrawal UI](https://explorer.mayan.finance/withdraw-fee-swift).
