...
Each bridging method within the Mayan protocol has its own unique referral fee behavior and collection mechanism. This document explains how referral fees are earned across all bridging methods, details fee collection mechanisms, and guides you through configuring referral fees in the SDK effectively. 

Referral fees collected are paid directly to the wallet addresses specified by the integrators acting as referrers, ensuring earned fees go straight to their accounts.
...
P.S. Even if you don’t plan to charge Referrer fees, it’s important to set your referrer wallet address. This allows you to track all swaps going through your widget or SDK accurately and be ready to earn fees if you decide to enable them later.