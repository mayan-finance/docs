...
sidebarTitle: "Forwarder Contract"
---
...
| permitParams | PermitParams | Signed permission (eip-2612) Pass zero for all values if you don't want to use it |
...
| Parameter | Type | Description |
| --- | --- | --- |
| amountIn | uint256 | Input amount of native token |
| swapProtocol | address | Contract address of swap protocol |
