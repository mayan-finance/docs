...
The API key is used for the [MPS panel](https://mps.mayan.finance) and the event WebSocket. Getting the deposit address from a quote works **without** one. Need a key? Email [support@mayan.finance](mailto:support@mayan.finance).
