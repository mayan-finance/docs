...
// A stable per-user id (any 20-byte value). Reusing it always yields the same address.
const userId = "0x00000000000000000000000000000000000000a1";
...
// Left-pad a 20-byte EVM address to a 32-byte value (used for the EVM destination).
const toBytes32 = (a: string) => "0x" + a.replace(/^0x/, "").padStart(64, "0");
...
const userId = "0x00000000000000000000000000000000000000b2";
