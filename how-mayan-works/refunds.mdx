...
<Warning>
  **Needs engineering input.** How long a refund takes and whether it is automatic. Whether the deadline window is the same across all four routes, and what it typically is. Whether MCTP and Wormhole Swap refund differently, given there may be no locked-asset conversion. What happens to a refunded payload swap. Whether anything other than a missed deadline triggers a refund, and how often refunds happen.
</Warning>