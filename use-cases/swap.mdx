...
- [**Avail Nexus**](https://mayan.finance/blog/mayan-unlocks-high-value-cross-chain-transfers-in-avail) routes cross-chain execution through a single interface at every transaction size, up to \$10M in one transfer.
- [**SwapKit**](https://mayan.finance/blog/mayan-unlocks-instant-cross-chain-swaps-on-swapkit) added instant cross-chain swaps to its routing, so its integrators reach chains they had no route to before.
