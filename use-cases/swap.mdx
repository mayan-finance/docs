...
Three transfer methods sit underneath a swap, each suited to a different size and asset profile. Swift routes single swaps up to around \$1M depending on the chain, and MCTP and Fast MCTP carry up to around \$10M.
