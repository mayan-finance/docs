...
**The cost stays low at size.** Fast MCTP routes stablecoin transfers over Circle's CCTP, built for ultra-low slippage, and carries up to around \$10M in a single transaction.
