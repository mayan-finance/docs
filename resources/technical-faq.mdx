...
Swift is the fastest path and covers most swaps, settling in around 6 seconds. MCTP routes over Circle's CCTP and suits high-value stablecoin transfers: Fast MCTP settles in around 20 seconds, standard MCTP in around two minutes. Wormhole Swap uses the Wormhole Token Bridge for low-slippage transfers of assets like SOL and ETH, and settles in around two minutes. See [Swift](/architecture/swift), [MCTP](/architecture/mctp) and [Wormhole Swap](/architecture/wh-swap).
