...
<Tabs>
  ...
  <Tab title="From Solana">
    ...
    For manual control over the transaction, `createSwapFromSolanaInstructions` returns the instructions instead. See [advanced](/build/sdk/advanced).
  </Tab>
  <Tab title="From Sui">
    ```typescript
...
<CardGroup cols={2}>
  ...
  <Card title="Advanced" icon="wrench" href="/build/sdk/advanced">
    Manual transaction building, custom refund addresses, fee splitting.
  </Card>
</CardGroup>