...
| --- | --- | --- | --- |
| [Swift](/architecture/swift) | ~6 seconds | Intent-based fills from driver capital already sitting on the destination chain. | Most swaps, up to around \$1M. |
| [MCTP / Fast MCTP](/architecture/mctp) | ~20 seconds on Fast MCTP, ~2 minutes on MCTP | Circle's CCTP as the highway. | High-value and stablecoin transfers, up to around \$10M. |
| [Wormhole Swap](/architecture/wh-swap) | ~2 minutes | The Wormhole Token Bridge. | Low-slippage transfers of high-value SOL and ETH. |
